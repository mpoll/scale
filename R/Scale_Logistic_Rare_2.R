...
rare.logistic.example.2    <- function(){
...
beta.truth      <<- c(-20,2,-2,2)            # True parameters
...
design.thresh   <<- 3                     # Thresholding of truncated Normals

examp.design <<- cbind(1,matrix(rtnorm((dimen-1)*dsz,mean=0,sd=1,lower=-design.thresh,upper=design.thresh),dsz,dimen-1))
